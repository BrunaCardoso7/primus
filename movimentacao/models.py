...
class Movimentacao(BaseModel):
    ...
    ie_tipo_movimentacao = models.CharField(choices=IeTipoMovimentacaoChoice.choices, max_length=2, default=IeTipoMovimentacaoChoice.entrada, blank=True, null=True)
